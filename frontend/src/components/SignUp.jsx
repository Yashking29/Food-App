    ...
    <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
      ...
      <div className="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        <form  onSubmit={handleSubmit} >
          ...
          <div>
            <label className="block font-medium text-sm text-gray-700" htmlFor="email">UserName</label>
            <input type="username" name="username" placeholder="username" className="w-full rounded-md py-2.5 px-4 border text-sm outline-[#f84525]" onChange={ (e) => setUsername(e.target.value) }/>
          </div>
