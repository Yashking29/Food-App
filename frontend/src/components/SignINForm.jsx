  ...
  const handleSubmit =(e)=>{
    ...
    Axios.post("http://localhost:3000/auth/login",{
       ...
       if(response.data.status){
          ...
          localStorage.setItem('namex',response.data.namex);
          setuser(email);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-4">
            ...
            <div className="relative">
              <input id="password" type="password" name="password" placeholder="Password" required autoComplete="current-password" className="w-full rounded-md py-2.5 px-4 border text-sm outline-[#f84525]"  onChange={ (e) => setPassword(e.target.value)} />
          ...
          <div className="flex items-center justify-end mt-4">
            ...
            <Link to="/forgotpassword" className="hover:underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Forgot your password?</Link>
